...
@:bitmap("assets/images/logo.png") class LogoImage extends BitmapData { }
@:font(Arial) class CustomFont extends Font {}
...
class CustomPreloader extends FlxBasePreloader
{
    ...
    override function create():Void 
    {
        ...
        text = new TextField();
        text.defaultTextFormat = new TextFormat("Dungeoner", Std.int(24 * ratio), 0xffffff, false, false, false, "", "", TextFormatAlign.CENTER);
