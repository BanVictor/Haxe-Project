...
class CombatHUD extends FlxTypedGroup<FlxSprite>
{
	...
	static public var wait:Bool = true; // this flag will be set to true when don't want the playerSprite to be able to do anything (between turns)
	...
	public function new()
	{
		...
		playerHealthCounter = new FlxText(0, playerSprite.y + playerSprite.height + 2, 0, "10 / 10", 8);
